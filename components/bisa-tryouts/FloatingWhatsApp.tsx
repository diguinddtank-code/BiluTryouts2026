    ...
    <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-[60] flex items-center justify-end pointer-events-none">
      ...
      <div className="relative pointer-events-auto">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="w-12 h-12 sm:w-14 sm:h-14 bg-[#0a1f14] rounded-full flex items-center justify-center shadow-[0_4px_15px_rgba(0,0,0,0.3)] hover:shadow-[0_0_20px_rgba(204,255,0,0.5)] transition-shadow relative z-20 border-2 border-[#ccff00]"
        >
