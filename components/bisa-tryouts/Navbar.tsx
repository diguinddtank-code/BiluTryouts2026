...
export function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#0a1a0a]/90 backdrop-blur-md border-b border-[#ccff00]/20 py-2' : 'bg-transparent py-4 md:py-8'}`}>
